...
/**
 * Tests for DynamicProgrammingBalanceWeightSystem.
 *
...
public class DynamicProgrammingBalanceWeightSystemTest {
    ...
    private DynamicProgrammingBalanceWeightSystem bwsys;
    ...
    @Before
    public void setUp() {
        this.bwsys = new DynamicProgrammingBalanceWeightSystem(DEFAULT_FAMILY);
    }
